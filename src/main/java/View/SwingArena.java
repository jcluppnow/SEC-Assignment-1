...
public class SwingArena extends JPanel
{
	...
	private static final String FORTRESS_IMAGE_FILE = "fortress.png";
     ...
     */
    public SwingArena(GameMap inGameMap)
    {
		...
		URL fortressURL = getClass().getClassLoader().getResource(FORTRESS_IMAGE_FILE);
        if(url == null || fortressURL == null)
        {
			if (url == null)
			{
		...
		fortressIcon = new ImageIcon(fortressURL);
		gameMap = inGameMap;
		gridWidth = gameMap.getHeight();
		gridHeight = gameMap.getWidth();
    ...
    public void paintComponent(Graphics g)
    {
		...
		drawImage(gfx, fortressIcon, gameMap.getFortressX(), gameMap.getFortressY()); 
    }
